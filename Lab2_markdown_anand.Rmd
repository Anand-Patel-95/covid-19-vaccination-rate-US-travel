...
#### Run ANOVA f-tests to see if extra predictors explain more variance
...
anova(model_2, lm(formula = log10(Number.of.Long.Trips) ~ Series_Complete_Pop_Pct + log10(County.POP) + log10(County_Median_Income) + MEDIAN_AGE_TOT, data = trips.vs.vaccine.df), test = "F")
