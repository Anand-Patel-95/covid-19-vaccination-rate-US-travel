...
pairs(~log10(Number.of.Long.Trips) + Series_Complete_Pop_Pct + log10(County.POP) + log10(County_Median_Income) + isRepublican, data = trips.vs.vaccine.df)
```
...
model_3 = lm(formula = log10(Number.of.Long.Trips) ~ Series_Complete_Pop_Pct + log10(County.POP) + log10(County_Median_Income) + isRepublican, data = trips.vs.vaccine.df)
...
(plot_model_3a | plot_model_3b) / (plot_model_3c | plot_model_3d) / plot_model_3e 
